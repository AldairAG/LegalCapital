        ...
        <div className="seccion-main">
            {isLoading ? (
                ...
                <section className='dashboard'>
                    ...
                    <div className="item-grid sec4"><CardPack dato={userData.staterPack} /></div>
                    <div className="item-grid sec5"><CardData dato={userData.walletDiv.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="WALLET DIVIDENDOS" /></div>
                    <div className="item-grid sec6"><CardData dato={userData.walletCom.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="COMMISSION WALLET" /></div>
                    <div className="item-grid sec7"><CardData dato={userData.bonoRangoRes.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="RESIDUAL RANK" /></div>
                    <div className="item-grid sec8"><CardData dato={userData.bonoRefDirect.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="DIRECT REFERRAL BONUS" /></div>
                    <div className="item-grid sec9"><CardData dato={userData.bonoIngresoRes.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="RESIDUAL INCOME FEES" /></div>
                    <div className="item-grid sec10"><CardData dato={userData.bonoIgualacion.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="MATCHING BONUS" /></div>
                    <div className="item-grid sec11"><CardData dato={userData.bonoFastTrack.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} type={false} titulo="FASTRACK BONUS" /></div>
                    <div className="item-grid sec12"><CardData dato={userData.matchingBonus2} type={false} titulo="LAUNCH PROMOTION" /></div>
